...
namespace XamarinExplorer.Services
{
	public class MockDataStore : Repository<Item>
	{
		...
		public MockDataStore()
		{
			...
			{
				new Item { Id = ++id, Text = "First item", Description="This is an item description." },
				new Item { Id = ++id, Text = "Second item", Description="This is an item description." },
				new Item { Id = ++id, Text = "Third item", Description="This is an item description." },
				new Item { Id = ++id, Text = "Fourth item", Description="This is an item description." },
				new Item { Id = ++id, Text = "Fifth item", Description="This is an item description." },
				new Item { Id = ++id, Text = "Sixth item", Description="This is an item description." },
			};
